...
public class PopUpEditarConta extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel11.setText("à");
        getContentPane().add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 410, 10, 30));
        ...
        getContentPane().add(btnSalvar, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 520, 90, 30));

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/botao-rosa.png"))); // NOI18N
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 510, 110, 50));
        ...
        getContentPane().add(btnCancelar, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 520, 100, 30));

        jLabel14.setIcon(new javax.swing.ImageIcon(getClass().getResource("/botao-cinza-outline.png"))); // NOI18N
        getContentPane().add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 510, 130, 50));
        ...
        getContentPane().add(jLabel23, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 380, 20, 20));
        ...
        getContentPane().add(tfTelefone, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 80, 240, 20));
        ...
        getContentPane().add(tfNumero, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 180, 240, 40));
        ...
        getContentPane().add(cbDia2, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 410, 100, 30));
        ...
        getContentPane().add(tfHorario, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 440, 240, 40));

        jLabel18.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jLabel18.setForeground(new java.awt.Color(58, 22, 46));
        jLabel18.setText("Horário de atendimento");
        getContentPane().add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 380, 150, 20));
